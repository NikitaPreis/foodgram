NAME_MAX_LENGHT = 256
USER_FOLLOW_THEMSELVES_ERROR_MESSAGE = ('Пользователь не может '
                                        'подписаться на себя')
...
RECIPE_ALREADY_EXIST_IN_LIST = 'Рецепт уже добавлен в список'
RECIPE_DOSNT_EXIST_IN_LIST = 'Рецепт не был добавлен в список'
...
COOKING_TIME_VALIDATION_ERROR_MASSAGE = ('Время приготовления '
                                         'не может быть меньше 1 минуты')
MEASUREMENT_UNIT_MAX_LENGTH = 64
FOODGRAM_USERNAME_MAXLENGTH = 150
FOODGRAM_SECOND_NAME_MAXLENGTH = 150
